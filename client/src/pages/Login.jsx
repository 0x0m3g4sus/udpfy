    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black">
            ...
            <div className={`bg-neutral-800 p-8 mx-2 rounded-lg w-full max-w-md ${isOnAuthLoading ? 'hidden' : null}`}>
                <h1 className="text-[22px] font-bold text-center mb-6 text-orange-400">Login To <span className='bg-amber-900 px-1 rounded-[4px]'>Udpfy</span> With Your Google Account</h1>
